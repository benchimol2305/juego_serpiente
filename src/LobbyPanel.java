...
class LobbyPanel extends JPanel{
    public static final String TITLE_MESSAGE = "Java Play";
    public static final String CREATOR_MESSAGE = "Creado por Cesar Benchimol";
    ...
    public static final String[] MENU_ITEMS = {"Jugar", "Mejores players", "Salir"};
